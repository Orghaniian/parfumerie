    ...
    <ul>
      <li>
        <ul>
          <li class="btn-menu">
            ...
            <router-link :to="{ name: 'Connexion' }" v-else>
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="4em" height="4em"  preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                <path d="M14 12l-4-4v3H2v2h8v3m12-4a10 10 0 0 1-19.54 3h2.13a8 8 0 1 0 0-6H2.46A10 10 0 0 1 22 12z"/>
              </svg>
            </router-link>
          </li>
          <li class="btn-menu">
      ...
      <li>
        <ul>
          ...
          <li class="btn-menu" v-if="admin">
            <router-link :to="{ name: 'Commandes' }" >
              <svg xmlns="http://www.w3.org/2000/svg" width="42.625" height="42.625" viewBox="0 0 42.625 42.625">
                <path d="M43.313,21.96A21.313,21.313,0,0,1,8.625,38.594a2.061,2.061,0,0,1-.158-3.06l.968-.968a2.066,2.066,0,0,1,2.741-.171,15.813,15.813,0,1,0-1.009-23.916l4.362,4.362a1.375,1.375,0,0,1-.972,2.347H2.063A1.375,1.375,0,0,1,.688,15.813V3.32a1.375,1.375,0,0,1,2.347-.972L7.278,6.59A21.312,21.312,0,0,1,43.313,21.96ZM27.765,28.73l.844-1.085a2.062,2.062,0,0,0-.362-2.894l-3.5-2.721V13.063A2.062,2.062,0,0,0,22.688,11H21.313a2.062,2.062,0,0,0-2.062,2.063V24.72l5.621,4.372A2.063,2.063,0,0,0,27.765,28.73Z" transform="translate(-0.688 -0.688)"/>
              </svg>
            </router-link>
          </li>
          <li class="btn-menu" v-if="admin">
            <router-link :to="{ name: 'Clients' }">
              <svg width="51" height="42" viewBox="0 0 51 42" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M36.5 33.25C36.5 30.3326 35.3411 27.5347 33.2782 25.4718C31.2153 23.4089 28.4174 22.25 25.5 22.25C22.5826 22.25 19.7847 23.4089 17.7218 25.4718C15.6589 27.5347 14.5 30.3326 14.5 33.25V41.5H36.5V33.25Z"/>
          ...
          <li class="btn-menu" v-if="admin"><router-link to="/">
          ...
          <li class="btn-menu" v-if="logged && !admin">
            <router-link :to="{name: 'Profil'}">
              <svg xmlns="http://www.w3.org/2000/svg" width="37.5" height="37.5" viewBox="0 0 37.5 37.5">
                <path d="M25,25a9.375,9.375,0,1,0-9.375-9.375A9.4,9.4,0,0,0,25,25Zm0,4.688c-6.211,0-18.75,3.164-18.75,9.375V43.75h37.5V39.063C43.75,32.852,31.211,29.688,25,29.688Z" transform="translate(-6.25 -6.25)"/>
              </svg>
            </router-link>
          </li>
        </ul>
